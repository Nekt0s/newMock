        ...
        while (true) {
            ...
            if (isValid) {
                break;
                         ...
                         System.out.println("""
                     Пасиба Санек, выручаешь <3

                     Всё как в прошлом году: 
                     1) Убедись что каждому выпал т.Санта.  
                     2) Никто не дарит нескольким людям.
                     3) Парочки не дарят подарки друг другу.
                     Список пар:
                     Даша - Леша, Настя - Ильнар, Катя - Никита.

                     Результаты рандомайзера:
                     """);
